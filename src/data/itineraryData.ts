...
export const ITINERARY_DAYS: ItineraryDay[] = [
  // --- SHANGHAI (TAG 1-4) ---
  {
    ...
    foodRecommendation: {
      dishGerman: 'Xiaolongbao (Gedämpfte Suppen-Teigtaschen)',
      dishChinese: '小笼包',
      dishPinyin: 'Xiǎolóngbāo',
      description: 'Zarte Teigtaschen gefüllt mit schmackhafter Füllung (z. B. Garnelen/Krabben, Geflügel oder Gemüse/Pilze) und heißer, aromatischer Brühe. Vorsichtig anbeißen und Brühe schlürfen!'
    },
  ...
  },
  {
    ...
    foodRecommendation: {
      dishGerman: 'Longjing Xiaren (Flussgarnelen mit feinem Longjing-Grüntee)',
      dishChinese: '龙井虾仁',
      dishPinyin: 'Lóngjǐng xiārén',
      description: 'Das eleganteste Traditionsgericht aus Hangzhou: Zarte Flussgarnelen, sanft gebraten mit frischen aromatischen Longjing-Teeblättern.'
    },
    logistics: {
  ...
  },
  {
    ...
    foodRecommendation: {
      dishGerman: 'Longjing Xiaren (Flussgarnelen gebraten mit frischem Longjing-Grüntee)',
      dishChinese: '龙井虾仁',
      dishPinyin: 'Lóngjǐng xiārén',
      description: 'Zarte Flussgarnelen, sanft gebraten mit frisch gepflückten Longjing-Teeblättern – herrlich feines, nussig-frisches Aroma.'
    },
    logistics: {
  ...
  },
  {
    ...
    foodRecommendation: {
      dishGerman: 'Shanghai Krabbenfleisch-Tofu (Xiefen Doufu)',
      dishChinese: '蟹粉豆腐',
      dishPinyin: 'Xièfěn dòufu',
      description: 'Zarter Seidentofu in einer reichhaltigen Sauce aus frischem Flusskrabbenfleisch und gelbem Krabben-Kaviar.'
    },
    logistics: {
