  ...
  const handleSendMessage = async (customText?: string) => {
    ...
    try {
      ...
      const botMsg: ChatMessage = {
        ...
        role: 'assistant',
        content: data.reply || 'Entschuldigung, ich konnte keine Antwort abrufen.',
        timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
      };
      ...
      const errorMsg: ChatMessage = {
        id: `err-${Date.now()}`,
        role: 'assistant',
        content: 'Es gab ein Verbindungsproblem zum Reise-Assistenten. Bitte versuche es noch einmal.',
        timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
      };
