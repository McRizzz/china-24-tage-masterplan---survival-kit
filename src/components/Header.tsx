...
import { MapPin, CheckCircle2, Wifi, WifiOff } from 'lucide-react';
              ...
              <p className="text-[11px] text-slate-400 flex items-center gap-1.5">
                {isOnline ? (
                  <>
                    ...
                    <span>3 Reisende • Online & Offline Sync</span>
                  </>
                ) : (
                  <>
                    <span className="inline-block w-1.5 h-1.5 rounded-full bg-amber-400" />
                    <span className="text-amber-300 font-medium">100% Offline Bereit</span>
                  </>
                )}
              </p>
            </div>
